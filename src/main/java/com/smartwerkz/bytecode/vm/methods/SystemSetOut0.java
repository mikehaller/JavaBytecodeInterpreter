...
public class SystemSetOut0 implements NativeMethod {

	@Override
	public void execute(RuntimeDataArea rda, Frame frame, OperandStack operandStack) {
		JavaObject newStdOutPrintStream = frame.getLocalVariables().getLocalVariable(0);
		...
		rcp.setValue("out", newStdOutPrintStream);
	}
