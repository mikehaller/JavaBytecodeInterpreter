...
public class SystemSetIn0 implements NativeMethod {

	@Override
	public void execute(RuntimeDataArea rda, Frame frame, OperandStack operandStack) {
		JavaObject newStdInInputStream = frame.getLocalVariables().getLocalVariable(0);
		...
		rcp.setValue("in", newStdInInputStream);
